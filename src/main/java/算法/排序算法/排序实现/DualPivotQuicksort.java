...
public class DualPivotQuicksort {
    ...
    /**
     * 如果要排序的数组长度小于这个常量，快速排序优先于归并排序使用。
     */
    private static final int QUICKSORT_THRESHOLD = 286;

    /**
     * 如果要排序的数组长度小于这个常量，插入排序优先于归并快速使用
     */
    private static final int INSERTION_SORT_THRESHOLD = 47;

    /**
     * 如果要排序的数组长度大于这个常量，基数排序优先于归并插入使用
     */
    private static final int COUNTING_SORT_THRESHOLD_FOR_BYTE = 29;

    /**
     * 如果要排序的数组长度大于这个常量，基数排序优先于归并快速使用
     */
    ...
    public void test() {
    	...
    	sort(arr,0,arr.length,new int[100],0,99);
    }

    /**
     * 根据给定的工作数组对数组指定范围进行排序
     * @param a 给定数组
     * @param left 数组左边界
     * @param right 数组有边界
     * @param work 工作数组
     * @param workBase 工作数组基数
     * @param workLen 工作数组长度
     */
    static void sort(int[] a, int left, int right,
                     int[] work, int workBase, int workLen) {
        //如果数组长度小于QUICKSORT_THRESHOLD，数组使用快速排序
